compare_high_abs = lambda x, y: abs(x) > abs(y)
compare_low_abs = lambda x, y: abs(x) < abs(y)

compare_high = lambda x, y: x > y
compare_low = lambda x, y: x < y

dataIn = [
    [[100000], compare_high_abs],
    [[10, -10], compare_high_abs],
    [[8, -4, 2], compare_high_abs],
    [[-50, -40, -30, -20, -10], compare_high_abs],
    [[200, -190, -180, 170, -160, 160, 140, 130], compare_high_abs],
    ...
    [[100000, 50000, -50000, 0], compare_low_abs],
    [[7, -3, 6, -4, 8, 0], compare_low_abs],
    [[5, -5, 5, -5, 5, -5, 5], compare_low_abs],
    [[8, -7, 8, -7, -8, 7, -8, 7, -8], compare_low_abs],
    ...
    [[3, -2], compare_high],
    [[-2, -1, 2], compare_high],
    [[-8, -5, 4, -5], compare_high],
    [[-9, -1, -10, 0, -1], compare_high],
    [[197, -275, 416, 265, -418, 288, -467, -450,
    ...
    [[-4, 0, -10, 2, 11, -6], compare_low],
    [[3, -2, -7, -2, 7, -14, 10], compare_low],
    [[-1, -2, 13, -7, 12, -7, 1, 11], compare_low],
    [[10, 6, 5, 12, -11, -18, 5, 12, 3], compare_low],
    [[-18, 13, 5, -8, 2, 14, -9, 19, -2, 16], compare_low],
...
dataOut = [
    ...
    [493, 411, 373, 336, 296, 275, 255, 170,
